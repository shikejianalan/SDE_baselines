...
#     --offline_data_dir ../data/gt_data-train_10cats_train_data-pushing_5epochs \
#     --val_data_dir ../data/gt_data-train_10cats_test_data-pushing_5epochs \
...
#     --sample_succ \
#     --pretrained_critic_ckpt /root/autodl-tmp/skj/where2act/code/logs/exp-model_3d_critic-pushing-None-train_3d_critic/ckpts/199-network.pth \
#     --device cuda:3 \
#     --overwrite
