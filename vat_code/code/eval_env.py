...
class Env(object):
    ...
    def load_object(self, urdf, material, articu_angle, state='closed'):
            ...
            if j.get_dof() == 1:
                ...
                if state == 'closed':
                    ...
                    if np.random.random() < 0.5:
                        ...
                        joint_angles.append(float(l))
                elif state == 'indicated':
                    if articu_angle >= l and articu_angle <= r:
                        joint_angles.append(float(articu_angle))
                    else:
                        print("Your angle is illegal!")
                        joint_angles.append(float(r))
                else:
