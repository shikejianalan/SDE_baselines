CUDA_VISIBLE_DEVICES=3 xvfb-run -a python eval_3d_task_traj_score.py \
    --exp_suffix 2021052562 \
    --model_version model_3d_task_score_topk \
    --primact_type pushing \
    --category_types StorageFurniture \
    --data_dir_prefix ../data/gt_data \
    --offline_data_dir /home/wuruihai/where2actCode/data/gt_data-fixcam-Type-single_cabinet_train_data-pushing0p05_TD3_sample_concat/allShape_StorageFurniture_2021051211/NEW_TRAIN1 \
    --val_data_dir /media/wuruihai/sixt/where2act/logs/exp-model_3d_task_actor_dir_RL_raw-pushing-None-52502/45783_task40_diffProposal_1/EVAL \
    --affordance_dir /home/wuruihai/where2actCode/logs/exp-model_3d_task_score_topk-pushing-None-2021052562/ckpts/%d-network.pth \
