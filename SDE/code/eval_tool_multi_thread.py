...
class Evaluator:
    ...
    def test_contact(self, network, shape_id, camera_angle, articu_angle, save_dir):
        ...
        return_dict = {"shape_id": shape_id, "succ_time": succ_time, "total_time": total_time, "ds_value": float(ds_value) / (total_time ** 2)}
        print(return_dict)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--camera_angle_phi", type=float)
    parser.add_argument("--camera_angle_theta", type=float)
    ...
    parser.add_argument('--cuda_sel', type=str)
