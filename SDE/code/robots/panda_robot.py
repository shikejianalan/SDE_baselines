...
class Robot(object):
    ...
    def load_gripper(self, urdf, material, open_gripper=False):
    ...
    def move_to_target_pose_visu(self, target_ee_pose: np.ndarray, num_steps: int, visu=False, vis_gif=False, vis_gif_interval=200, cam=None):
        """
        Move the robot hand dynamically to a given target pose
        Args:
            target_ee_pose: (4, 4) transformation of robot hand in robot base frame (ee2base)
