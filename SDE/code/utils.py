...
def get_model_module(model_version, algorithm):
    importlib.invalidate_caches()
    if algorithm == 'w2a':
        return importlib.import_module('w2a_models.' + model_version)
    elif algorithm == 'vat':
        return importlib.import_module('vat_models.' + model_version)
